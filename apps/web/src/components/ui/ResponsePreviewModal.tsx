...
export default function ResponsePreviewModal({ log, onClose }: ResponsePreviewModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-[100] bg-black/70 backdrop-blur-sm flex items-center justify-center p-3 sm:p-6 overflow-y-auto animate-in fade-in duration-200">
      ...
      >
        {/* Modal Header */}
        <div className="flex items-center justify-between px-5 py-4 border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/80 dark:bg-zinc-900/80 rounded-t-xl">
          <div className="flex items-center gap-3 min-w-0">
            <div className={`p-2 rounded-lg ${isSuccess ? 'bg-emerald-500/10 text-emerald-500' : 'bg-rose-500/10 text-rose-500'}`}>
            ...
            <div className="min-w-0">
              ...
              <p className="text-xs text-zinc-500 font-mono truncate mt-0.5 flex items-center gap-1.5">
        ...
        <div className="px-5 py-2.5 bg-zinc-100/50 dark:bg-zinc-900/40 border-b border-zinc-200 dark:border-zinc-800/80 flex flex-wrap items-center justify-between gap-3 text-xs font-mono">
        ...
        <div className="px-5 py-2.5 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 flex flex-wrap items-center justify-between gap-3">
          {/* Main Navigation Tabs */}
          <div className="flex items-center gap-1 p-1 bg-zinc-100 dark:bg-zinc-900 rounded-lg text-xs font-medium">
            <button
          ...
          {/* Format Override Switcher (HTML, JSON, Markdown, Text, Image, Video) */}
          {activeTab === 'preview' && (
            <div className="flex items-center gap-1.5">
              ...
              <div className="flex items-center gap-1 bg-zinc-100 dark:bg-zinc-900 p-0.5 rounded-md text-[11px]">
                {(['HTML', 'JSON', 'MARKDOWN', 'TEXT', 'IMAGE', 'VIDEO'] as ResponseFormat[]).map((fmt) => (
                  <button
                    key={fmt}
